...
#define FIREBASE_HOST "https://home-automation-system-fbeeb-default-rtdb.firebaseio.com/"                     //Your Firebase Project URL goes here without "http:" , "\" and "/"
#define FIREBASE_AUTH "umxcReJXexsKcyTdHD4tv7ffQjHIKab0BcUAdZJL"

#define WIFI_SSID "ʍooɹɐds ʞɔɐſ"                                               //WiFi SSID to which you want NodeMCU to connect
